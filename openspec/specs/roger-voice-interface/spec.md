# Roger Voice Interface

## Purpose
Defines Roger's local voice interaction pipeline, including wake activation, instruction capture, local STT/TTS, preview, and return-to-listening behavior.
