...
#### Scenario: Pi router details requested
- **WHEN** Roger dispatches through Pi and the user requests router details for the task
- **THEN** Roger SHALL expose the Pi router details when available or SHALL clearly report that router details are unavailable for the current Roger entrypoint
